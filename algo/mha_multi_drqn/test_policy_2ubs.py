...
def load_and_run_policy(test_kwargs, model_path, config_path, n_episodes=1):
    ...
    for i_episode in range(n_episodes):
        with torch.no_grad():
            ...
            while not d:
                a, h2 = learner.take_actions(o, h, 0.05)
...
if __name__ == '__main__':
    start = 500  # TODO
    config_path = '/home/zlj/uav_rsma-master/mha_drqn_data/exp3/config.json'  # TODO
    test_ret_path = '/home/zlj/uav_rsma-master/mha_drqn_data/exp3/vars/test_p_ret.pickle'  # TODO
    train_ret_path = '/home/zlj/uav_rsma-master/mha_drqn_data/exp3/vars/ep_ret_list.pickle'  # TODO
    model_path = '/home/zlj/uav_rsma-master/mha_drqn_data/exp3/checkpoints/checkpoint_epoch'  # TODO
    test_kwargs = {"map": Rang400MapSpecial,
    ...
    for _ in range(10000):
        ...
        if saveif:
            shutil.copyfile(model_path2,
                            '/home/zlj/uav_rsma-master/experiment/experiment1/{}_ckp.pt'.format(data['expname']))
            shutil.copyfile(test_ret_path, '/home/zlj/uav_rsma-master/experiment/experiment1/{}_testReturns.pickle'.format(
                data['expname']))
            shutil.copy(train_ret_path,
                        '/home/zlj/uav_rsma-master/experiment/experiment1/{}_trainReturns.pickle'.format(data['expname']))
            save_var('/home/zlj/uav_rsma-master/experiment/experiment1/{}_data'.format(data['expname']), data)
            break
