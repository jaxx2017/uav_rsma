...
from algo.mha_multi_drqn.utils import set_rand_seed
...
def plot(init_info, uav_traj, jamming_power, args):
    ...
    for i, traj in enumerate(uav_traj):
        ...
        #                            [uav3_pos[1], uav3_pos_new[1]], linestyle='-', color='g', linewidth=2)
        # ubs4_trajectory, = ax[0].plot([uav4_pos[0], uav4_pos_new[0]],
        #                            [uav4_pos[1], uav4_pos_new[1]], linestyle='-', color='#000000', linewidth=2)
    ...
    # uav3_final_pos, = ax[0].plot(uav3_pos[0], uav3_pos[1], marker='o', color='g')
    # uav4_final_pos, = ax[0].plot(uav4_pos[0], uav4_pos[1], marker='o', color='#000000')
...
if __name__ == '__main__':
    start = 500  # TODO
    config_path = '/home/zlj/uav_rsma-master/mha_drqn_data/exp8/config.json'  # TODO
    test_ret_path = '/home/zlj/uav_rsma-master/mha_drqn_data/exp8/vars/test_p_ret.pickle'  # TODO
    train_ret_path = '/home/zlj/uav_rsma-master/mha_drqn_data/exp8/vars/ep_ret_list.pickle'  # TODO
    model_path = '/home/zlj/uav_rsma-master/mha_drqn_data/exp8/checkpoints/checkpoint_epoch'  # TODO
    test_kwargs = {"map": GeneralMap,
                   "fair_service": False}  # TODO
    saveif = False  # TODO
    for _ in range(10000):
        ...
        if saveif:
            shutil.copyfile(model_path2,
                            '/home/zlj/uav_rsma-master/experiment/experiment3/{}_ckp.pt'.format(data['expname']))
            shutil.copyfile(test_ret_path, '/home/zlj/uav_rsma-master/experiment/experiment3/{}_testReturns.pickle'.format(
                data['expname']))
            shutil.copy(train_ret_path,
                        '/home/zlj/uav_rsma-master/experiment/experiment3/{}_trainReturns.pickle'.format(data['expname']))
            save_var('/home/zlj/uav_rsma-master/experiment/experiment3/{}_data'.format(data['expname']), data)
            break
